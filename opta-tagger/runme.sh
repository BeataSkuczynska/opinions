...
python2.7 opta_patterns.py input_data/conll-format/S_skladnica_test.conll input_data/conll-format/full_skladnica_test.conll
# (3) convert data to internal CRF Suite format:
cat input_data/conll-format/full_skladnica_test.conll | python2.7 crffeaturebuilder.py > input_data/crf-format/skladnica_test.crfsuite.txt
# (4) tag the data:
crfsuite-0.12/bin/crfsuite tag -m models/opta.model input_data/crf-format/skladnica_test.crfsuite.txt > input_data/crf-format/tagged_output_skladnica.conll
